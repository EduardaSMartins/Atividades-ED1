...
/**
 * Remove o topo da Pilha <p>, aloca um espaço dinamicamente para armazenar o * elemento removido e 
 * devolve o endereço do elemento.
...
Boolean pilha_pop2(Pilha* p, Tipo* end){
    ...
    *end = aux->topo->dado;
    aux->topo->prox = NULL;
    p->topo = p->topo->prox;
    if(aux->topo->prox == NULL) return True;
    else return False;
}
